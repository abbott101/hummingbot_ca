...
WSS_URL = "wss://wspool.cloudex.cc"

PUBLIC_API_VERSION = "v3"
PRIVATE_API_VERSION = "v3"

# Public API endpoints or CcexClient function
TICKER_PRICE_CHANGE_PATH_URL = "/api/v1/ccex/ticker24"
TICKER_BOOK_PATH_URL = "/ticker/bookTicker"
EXCHANGE_INFO_PATH_URL = "/api/v1/ccex/symbols"
PING_PATH_URL = "/api/v1/ccex/ping"
SNAPSHOT_PATH_URL = "/api/v1/ccex/depth"
SERVER_TIME_PATH_URL = "/api/v1/ccex/time"

# Private API endpoints or CcexClient function
ACCOUNTS_PATH_URL = "/api/v1/ccex/account"
MY_TRADES_PATH_URL = "/api/v1/ccex/myTrades" # 调试返回值
ORDER_PATH_URL = "/api/v1/ccex/queryOrder" # 调试返回值
ORDER_CANCEL_PATH_URL = "/api/v1/ccex/cancel" # 调试返回值

CCEX_USER_STREAM_PATH_URL = "/userDataStream"
...
# api agent
API_AGENT_BASE = "http://127.0.0.1:8080"
API_AGENT_BALANCE = "/api/v1/ccex/account"
API_AGENT_NEWORDER = "/api/v1/ccex/newOrder"
...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=SNAPSHOT_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
              linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT, 50),
                             LinkedLimitWeightPair(RAW_REQUESTS, 1)]),
    RateLimit(limit_id=CCEX_USER_STREAM_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
